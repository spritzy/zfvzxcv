...
local Library = {
    Theme = {
        Accent = {
            Color3.fromHex("#d059ff"), -- Color3.fromHex("#a280d9"), -- Color3.fromRGB(255, 42, 10), Color3.fromHex("#3599d4")
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Library.Theme.Logo = Utility.AddImage("Abyss/Assets/UI/FinalLogo.png", "https://i.imgur.com/QwgCokF.png")
        --
